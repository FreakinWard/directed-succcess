...
export default function NavItem({ title, id, items, colorInvert = false }: Props): ReactElement {
            ...
            <Grid item key={i} xs={items.length > 12 ? 6 : 12}>
              <Button
                ...
                sx={{
                  ...
                  color:
                    activeLink === p.href ? theme.palette.primary.main : theme.palette.text.primary,
                  backgroundColor:
